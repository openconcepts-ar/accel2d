...
from wpu import gen_accel_cores #indirect instancing
#from accel_glue import gen_accel_cores #direct instancing
...
class SimSoC(SoCCore):
    def __init__(self, clocks,
        ...
        pixel_bus_width        = 32, #pixel bus width (framebuffer access width)
        ...
        **kwargs):
        ...
        if with_video_framebuffer:
            ...
            self.add_video_framebuffer(phy=self.videophy, timings="800x600@60Hz", format="rgb888", clock_domain="pix")
            self.videophy.comb += video_pads.valid.eq(~self.video_framebuffer.underflow)

            add_accel_cores(self, pixel_bus_width)
